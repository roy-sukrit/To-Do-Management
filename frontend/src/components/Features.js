...
import ScrollTrigger from 'gsap/ScrollTrigger';
 import '../styles/Features.css'; 
  ...
  function Features() {   useEffect(() => {     gsap.to('.feature-card', {       opacity: 1,       y: 0,       duration: 0.8,       stagger: 0.2,       scrollTrigger: {         trigger: '.features',         start: 'top center'       }     });   }, []);   
                       ...
                       <div className="feature-icon">🤝</div>     
                             <h3>Collaborate</h3>         
                               <p>Share lists and assign tasks to team members easily.</p>      
                                   ...
                                   </div>     </section>   ); }  export default Features;